...
class Test_Solar_Json extends Solar_Test {
    ...
    public function testEncode_dequote()
    {
        ...
        $expect = <<< ENDEXPECT
{"parameters":Form.serialize('foo'),"asynchronous":true,"onSuccess":function(t) { new Effect.Highlight(el, {"duration":1});},"on404":function(t) { alert('Error 404: location not found'); },"onFailure":function(t) { alert('Ack!'); },"requestHeaders":["X-Solar-Version","1.0.0beta3","X-Foo","Bar"]}
ENDEXPECT;
